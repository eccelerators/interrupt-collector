...
package InterruptCollectorIfcPackage is
	...
	type T_InterruptCollectorIfcAxi4LiteDown is
	record
		AWVALID : std_logic;
	...
	type T_InterruptCollectorIfcAxi4LiteUp is
	record
		AWREADY : std_logic;
		WREADY : std_logic;
		BVALID : std_logic;
	...
	type T_InterruptCollectorIfcAxi4LiteAccess is
	record
	...
	record
		Axi4LiteDown : T_InterruptCollectorIfcAxi4LiteDown;
		Axi4LiteUp : T_InterruptCollectorIfcAxi4LiteUp;
		Axi4LiteAccess : T_InterruptCollectorIfcAxi4LiteAccess;
